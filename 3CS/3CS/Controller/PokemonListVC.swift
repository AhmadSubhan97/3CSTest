...
class PokemonListVC: UICollectionViewController {
...
extension PokemonListVC {
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return searchMode ? filteredPokemon.count : pokemon.count
    }
    
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! PokedexCell
        
        cell.pokemon = searchMode ? filteredPokemon[indexPath.row] : pokemon[indexPath.row]
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        controller.pokemon = searchMode ? filteredPokemon[indexPath.row] : pokemon[indexPath.row]
...
extension PokemonListVC: PokedexCellDelegate {
...
extension PokemonListVC: InfoViewDelegate {
